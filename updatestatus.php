...
if (n==null || n=="" )
 ...
 return false; 
  ...
  var m=document.forms["myform"]["oldstatus"].value;

if (m==null || m=="" )
  {
  
   alert(" old status must be filled out");
 return false; 
  } 
 var p=document.forms["myform"]["status"].value;
   if (p==null || p=="" )
  {
   ...
   alert(" New Status of BOOK : READ/UNREAD ");
 return false; 
  } 
...
if(isset($_POST['submit']))
{
	...
	{ 		//$sql = "INSERT INTO book  (author,bookname,status) VALUES ('$authorname','$bookname','$status')";
		        $sql="UPDATE book SET status='$status' WHERE author='$authorname' AND bookname='$bookname' AND status='$oldstatus'";
		if($mysqli->query($sql) === true)
			echo '<div style="position:absolute;top:200px; left:250px;"><p style="color:green;">Perfet!!!Book status Has Been Changed Successfully<p></div>' ;
		else
...
?>
         ...
         <form name="myform" action="updatestatus.php" method="POST" left ="250px" top ="250px"  onSubmit="return validateForm();">
		...
		<table  bgcolor="" align="center">
			...
			<tr>
				...
				<td width="50%">
					<input maxlength="50" name="oldstatus" id="repass" type="text">&nbsp;*
				</td>
			</tr>
			<tr>
				<td>&nbsp;</td>
