...
if (n==null || n=="" )
 ...
 return false; 
   ...
   var m=document.forms["myform"]["oldbookname"].value;

if (m==null || m=="" )
  {
  
   alert(" old bookname must be filled out");
 return false; 
  }
...
if(isset($_POST['submit']))
{
	...
	{ 		//$sql = "INSERT INTO book  (author,bookname,status) VALUES ('$authorname','$bookname','$status')";
		        $sql="UPDATE book SET bookname='$bookname' WHERE author='$authorname' AND status='$status' AND bookname='$oldbookname'";
		if($mysqli->query($sql) === true)
			echo '<div style="position:absolute;top:200px; left:250px;"><p style="color:green;">Perfet!!!Bookrname Has Been Changed Successfully<p></div>' ;
		else
...
?>
         ...
         <form name="myform" action="updatebookname.php" method="POST" left ="250px" top ="250px"  onSubmit="return validateForm();">
		...
		<table  bgcolor="" align="center">
			...
			<tr>
				...
				<td width="50%">
					<input maxlength="50" name="oldbookname" id="pass" type="text">&nbsp;*
				</td>
			</tr>
                          <tr>
				<td>&nbsp;</td>
