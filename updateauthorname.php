...
if (y==null || y=="")
  ...
  return false;
   ...
   var m=document.forms["myform"]["oldauthorname"].value;

if (m==null || m=="" )
  {
  
   alert(" old authorname  must be filled out");
 return false; 
  }
...
if(isset($_POST['submit']))
{
	...
	$status=$_POST['status'];
        $oldauthorname=$_POST['oldauthorname'];
	...
	{ 		//$sql = "INSERT INTO book  (author,bookname,status) VALUES ('$authorname','$bookname','$status')";
		        $sql="UPDATE book SET author='$authorname' WHERE bookname='$bookname' AND status='$status' AND author='$oldauthorname'";
		if($mysqli->query($sql) === true)
			echo '<div style="position:absolute;top:200px; left:250px;"><p style="color:green;">Perfet!!!Authorname Has Been Changed Successfully<p></div>' ;
		else
...
?>
         ...
         <form name="myform" action="updateauthorname.php" method="POST" left ="250px" top ="250px"  onSubmit="return validateForm();">
		...
		<table  bgcolor="" align="center">
			...
			<tr>
				<td colspan="2"><br/>
                        ...
                        <tr>
				<td width="30%">Author Name :</td>
				<td width="50%">
					<input maxlength="50" name="oldauthorname" id="pass" type="text">&nbsp;*
				</td>
			</tr>
                        <tr>
				<td>&nbsp;</td>
